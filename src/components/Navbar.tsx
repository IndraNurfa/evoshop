      ...
      <nav className="fixed top-0 left-0 z-50 mt-0 flex w-full max-w-full items-center justify-between border-b border-black bg-white p-2 dark:border-b-white dark:bg-black">
        ...
        {session ? (
          ...
          <div className="mr-4 flex items-center space-x-2">
            <p className="text-gray-700 dark:text-gray-200">Not signed in</p>
            <Link href={"/login"}>
              <button className="rounded-lg bg-indigo-600 px-4 py-2 text-white transition hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 focus:outline-none dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Login
              </button>
            </Link>
          </div>
